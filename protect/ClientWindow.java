...
public class ClientWindow extends JFrame {
	...
	JTextField portField, nameField, ipField;
	JTextArea messageArea;
	JButton connectButton, confirmButton, sendButton, emptyButton;
	...
	JLabel portLabel, ipLabel, nameLabel, onlineLabel;
	...
	ClientWindow() {
		...
		pp1.setLayout(new GridLayout(2, 1));
		pp1.add(p1);
		pp1.add(p2);
	...
	public static void main(String args[]) {
		ClientWindow wm = new ClientWindow();
		wm.show();
	}
}
